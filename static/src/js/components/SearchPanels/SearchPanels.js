...
class SearchPanels extends PureComponent {
  ...
  render() {
    ...
    collectionResultsPrimaryHeading = `${commafy(collectionHits)} Matching Collections`
    ...
    console.log('collectionResultsHeaderMetaPrimaryText', collectionResultsHeaderMetaPrimaryText)
    ...
    console.log('initialGranulesLoading', initialGranulesLoading)
    ...
    console.log('initialCollectionsLoading', initialCollectionsLoading)
        ...
        <Route
          ...
          render={
            (props) => {
              ...
              console.log('activePanelFromProps', activePanelFromProps)
