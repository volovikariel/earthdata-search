...
describe('RadioSettingDropdown component', () => {
  ...
  test('renders correctly when items links are provided', () => {
    ...
    // expect(enzymeWrapper.find(RadioSettingDropdownItem).length).toEqual(1)
  })

  // describe('when the mouse is moved', () => {
  //   describe('if the mouse is not over the elements', () => {
  ...
  //       console.log('windowEventMap', windowEventMap)
